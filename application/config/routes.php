...
$route['show/index/city/(:num)/page/(:num)'] = 'show/index/$1/$2';
$route['search/index'] = 'show/search';
//images list
$route['show/images'] = 'show/images';
$route['show/setimages'] = 'show/setimages';
$route['show/setwrite'] = 'show/setwrite';
//hotel list
$route['show/hotel'] = 'show/hotel';
$route['show/hotelimages'] = 'show/hotelimages';
//restaurants list
